...
def reflect_all_chats(user_id):
    ...
    if user_chats and chats:
        for chat_id in user_chats:
            ...
            chat_description = chats[chat_id]["chat_description"]
            chat_creator = chats[chat_id]["creator"]
            chat_dict["chat_id"] = chat_id
            chat_dict["chat_name"] = chat_name
            chat_dict["security_level"] = chat_level
            chat_dict["chat_description"] = chat_description
            chat_dict["chat_creator"] = chat_creator
